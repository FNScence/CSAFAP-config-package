...
## Version History
- ***Base features (version 1.0):*** (21st September 2024)
...
- ***New with version 1.3:*** (26th September 2024)
...
- ***New with version 1.4:*** (29th September 2024)
...
- ***New with version 1.5:*** (28th September 2024)
...
- ***New with version 1.6:*** (29th September 2024)
...
- ***New with version 1.7:*** (3rd October 2024)
...
- ***New with version 2.0:*** (15th Dezember 2024)
...
- ***New with version 2.1:*** (10th January 2025)
...
- ***New with version 2.2:*** (18th January 2025)
	- Added a few T-side line-ups for Train (after the first pro matches on the map)

- ***New with version 2.3:*** (4th Feburary 2025)
...
- ***New with version 2.4:*** (9th Feburary 2025)
...
- ***New with version 2.5:*** (1st March 2025)
 ...
 - ***New with version 2.6:*** (5th April 2025)
  	- Added/changed practice mode line-ups for Train, Anubis, Inferno

 - ***New with version 2.7:*** (15th April 2025)
 ...
 - ***New with version 2.8:*** (29th April 2025)
 ...
 - ***New with version 2.9:*** (11th May 2025)
...
- ***New with version 2.10:*** (18th July 2025)
...
- ***New with version 2.20:*** (29th September 2025)
...
- ***New with version 2.21:*** (1st October 2025)
...
- ***New with version 2.22:*** (2nd October 2025)
	- Fixed an issue with auto line-up logic

- ***New with version 2.23:*** (2nd October 2025)
	- Fixed auto line-ups breaking after first line-up

- ***New with version 2.24:*** (4th October 2025)
...
- ***New with version 2.25:*** (5th October 2025)
...
- ***New with version 2.26:*** (8th October 2025)
...
- ***New with version 2.32:*** (18th Dezember 2025)
 ...
 - ***New with version 2.33:*** (11th January 2026)
 ...
 - ***New with version 3.0:*** (18th January 2026)
...
- ***New with version 3.1:*** (20th January 2026)
...
- ***New with version 3.2:*** (22nd January 2026)
	- Added new rapid fire × follow recoil toggle bind
	- Removed bhop bind (patched)

- ***New with version 3.3:*** (22nd January 2026)
...
- ***New with version 3.4:*** (23rd January 2026)
...
- ***New with version 3.5:*** (1st February 2026)
...
- ***New with version 3.6:*** (7th February 2026)
 	- Reverted to manual  side selection (2 keybinds) for auto line-ups

- ***New with version 3.7:*** (14th February 2026)
...
- ***New with version 3.12:*** (23rd March 2026)
...
- ***New with version 3.13:*** (1st April 2026)
	- Fixed practice mode spawn point teleport balloons to work when playing with friends

- ***New with version 3.14:*** (8th April 2026)
	- Added support for mouse_inverty 1 when using auto line-ups

- ***New with version 3.15:*** (19th April 2026)
	- Added non-ticker JT and WJT binds (just like CSGO)

- ***New with version 3.16:*** (22th April 2026)
	- Fixed loading structure while using faceitAC
 	- Removed auto line-up support on faceit servers
...
- ***New with version 3.20:*** (10th July 2026)
...
- ***New with version 3.21:*** (11th July 2026)
...
- ***New with version 3.22:*** (16th July 2026)
	- Reintroduced (W-)JT binds (radialradio method)
	- Reintroduced null binds (non-ticker version)
 	- Removed all ticker features (patched on 14th July 2026) - This included removal of:
       - CS:GO-style  (W-)JT binds
       - Better follow recoil
       - Rapid Fire pistols
       - Release nades on reload key
       - Crouch-jump bind
